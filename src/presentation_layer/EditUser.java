...
public class EditUser extends JPanel {
	...
	private JButton butSearch, btnUpdate;
	...
	private void intialize() {
		...
		btnUpdate.setBounds(545, 297, 89, 23);
		add(btnUpdate);
		...
		btnUpdate.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				case JOptionPane.NO_OPTION:
					...
					JOptionPane.showMessageDialog(null, " Account.. not UPDATED", "EDIT USER",
							JOptionPane.INFORMATION_MESSAGE);
	...
	public boolean isValidOne() {
		if (!Validator.isPresent(txtUserSearch, "User ID"))
			return false;
		return true;
	}
	...
	public boolean isValidData() {
		if (!Validator.isPresent(txtName, "User Name "))
			return false;
		if (!Validator.isPresent(txtPassord, "Password "))
			return false;
